...
class Enemy {
    constructor(id, sprite, collaid, scope, scopeRadius, colliderPositionX, colliderPositionY, colliderPositionZ, colliderWidth, colliderHeight, colliderLength, pursuitZone, persecutionRadius, health, damage, attackDistance, attackSpeed, moveSpeed) {
        this.id = id;
        this.sprite = sprite;
    ...
    lee(grid, startPointX, startPointZ, searchPointX, searchPointZ, mapLength, mapWidth) {
        ...
        let waveNumber;
        let stop;
        if (grid[startPointZ][startPointX] == wall || grid[searchPointZ][searchPointX] == wall)
        ...
        if (grid[searchPointZ][searchPointX] === blank || grid[searchPointZ][searchPointX] === enemySelf)
     ...
     * @returns {boolean}
     */
    checkCollisionAxis(enemyPositionAxis, enemySize, positionCollision, sizeCollision, attackDistance = 0) {
